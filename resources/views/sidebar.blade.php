            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">CRM</span><span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span></a>
                    <ul class="menu-content">
                        <li class="{{ request()->is('dashboard') ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('dashboard')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">CRM Dashboard</span></a>
                        </li>
                        <li class="{{ request()->is('leads') ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('leads.index')}}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Leads(deals)</span></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class=" nav-item {{ Route::is('leads.kanban') ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{route('leads.kanban')}}"><i data-feather="grid"></i><span class="menu-title text-truncate" data-i18n="Kanban">Leads Kanban</span></a>
                </li>
